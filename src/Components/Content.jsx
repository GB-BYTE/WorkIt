              ...
              <div className="grid lg:grid-cols-3 md:pt-[88px] pt-[40px] lg:gap-20 sm:grid-rows-3 lg:h-[610px] px-4 lg:px-4 md:px-0 ">
                   ...
                   <div className="lg:block md:flex lg:gap-0 lg:pl-0 md:gap-8 md:pl-5">
                       <div className="flex justify-center">
                        ...
                        <div className="lg:pt-[56px] lg:text-center text-center md:text-start  md:pt-0 pt-[30px] pb-[30px] md:pb-0 ">
                    ...
                    <div className="lg:block md:flex lg:gap-0 lg:pl-0 md:gap-8 md:pl-5 pt-0 lg:pt-0 md:pt-[30px] ">
                       <div className="flex justify-center">
                            <div className="flex items-center justify-center border border-[#584D62] w-[56px] h-[56px] text-[24px] rounded-full ">
                               2
                            </div> 
